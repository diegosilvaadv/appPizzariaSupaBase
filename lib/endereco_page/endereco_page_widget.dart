...
import 'endereco_page_model.dart';
export 'endereco_page_model.dart';

class EnderecoPageWidget extends StatefulWidget {
  const EnderecoPageWidget({Key? key}) : super(key: key);

  @override
  _EnderecoPageWidgetState createState() => _EnderecoPageWidgetState();
}

class _EnderecoPageWidgetState extends State<EnderecoPageWidget> {
  late EnderecoPageModel _model;
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          'Selecione Seu Endereço Cadastrado.',
                          style:
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<List<UserEnderecosRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<UserEnderecosRow> listViewUserEnderecosRowList =
                              snapshot.data!;
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewUserEnderecosRowList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewUserEnderecosRow =
                                  listViewUserEnderecosRowList[listViewIndex];
                              return Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: FutureBuilder<ApiCallResponse>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final buscarCepApiCepResponse =
                                                snapshot.data!;
                                            return TextFormField(
                                              controller:
                                                  _model.buscarCepController,
                                              focusNode:
                                                  _model.buscarCepFocusNode,
                                              obscureText: false,
                                            ...
                                            setState(() {
                                              FFAppState()
                                                ...
                                                (e) => e
                                                  ...
                                                  ..bairro = ApiCepCall.bairro(
                                                    (_model.respAPI?.jsonBody ??
                                                        ''),
                                                  ).toString()
                                                  ..cidade = ApiCepCall.cidade(
                                                    (_model.respAPI?.jsonBody ??
                                                        ''),
                                                  ).toString()
                                                  ..uf = ApiCepCall.estado(
                                                    (_model.respAPI?.jsonBody ??
                                                        ''),
                                                  ).toString()
                                                  ..complemento =
