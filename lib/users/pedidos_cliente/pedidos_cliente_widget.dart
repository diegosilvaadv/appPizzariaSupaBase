                          ...
                          Padding(
                            ...
                            child: FutureBuilder<List<NumbersPedRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<NumbersPedRow> listViewNumbersPedRowList =
                                    snapshot.data!;
                                return ListView.builder(
                                  ...
                                  itemCount: listViewNumbersPedRowList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewNumbersPedRow =
                                                  ...
                                                  return Column(
                                                    ...
                                                    children: List.generate(
                                                        columnPedidosCarrinhoRowList
                                                            .length,
                                                        (columnIndex) {
                                                      final columnPedidosCarrinhoRow =
                                                          columnPedidosCarrinhoRowList[
                                                              columnIndex];
                                                      return Padding(
                                                        padding:
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            formatNumber(
                                                                              columnPedidosCarrinhoRow.precoProduto!,
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              'X ${columnPedidosCarrinhoRow.quanty?.toString()}',
                                                                              style: FlutterFlowTheme.of(context).headlineSmall.override(
                                                                                    fontFamily: 'Outfit',
                                                                  ...
                                                                  if (columnPedidosCarrinhoRow
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            columnPedidosCarrinhoRow.nomeMassa!,
                                                                            style:
                                                ...
                                                ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          6.0),
                                                  child: Image.network(
                                                    'https://images.unsplash.com/photo-1593560708920-61dd98c46a4e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxwaXp6YXxlbnwwfHx8fDE2OTk1NzI5MzV8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                                    width: 80.0,
                                                    height: 80.0,
                                                    fit: BoxFit.cover,
                                                  ),
