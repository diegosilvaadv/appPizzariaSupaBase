...
import 'detalhes_produtos2sab_model.dart';
export 'detalhes_produtos2sab_model.dart';

class DetalhesProdutos2sabWidget extends StatefulWidget {
  const DetalhesProdutos2sabWidget({Key? key}) : super(key: key);

  @override
  _DetalhesProdutos2sabWidgetState createState() =>
      _DetalhesProdutos2sabWidgetState();
}

class _DetalhesProdutos2sabWidgetState
    extends State<DetalhesProdutos2sabWidget> {
  late DetalhesProdutos2sabModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesProdutos2sabModel());
                              ...
                              if (FFAppState().condicao == 3) {
                                setState(() {
                                  FFAppState().addToProdutosDoCarrinho(
                                    ...
                                    nomeProduto:
                                        '${FFAppState().SaboresApp.sabor1} & ${FFAppState().SaboresApp.sabor2}',
                                    img:
